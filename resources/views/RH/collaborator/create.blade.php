        ...
        <div class="container">
            ...
            <div class="box-info">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input class="form-control" type="text" name="sdi" id="sdi" value="0.00" disabled>
                    </div>
                    <div class="col-md-2">
                        <label for="weekly_or_monthly_salary">Sueldo sem/men</label>
                        <input class="form-control" type="text" name="weekly_or_monthly_salary" id="weekly_or_monthly_salary" value="0.00" disabled>
                    </div>
                    <div class="col-md-2">
                        <label for="pantry_vouchers">Vales de despensa</label>
                        <input class="form-control" type="text" name="pantry_vouchers" id="pantry_vouchers" value="0.00" disabled>
                    </div>
                    <div class="col-md-2">
                        <label for="savings_fund">Fondo de ahorro</label>
                        <input class="form-control" type="text" name="savings_fund" id="savings_fund" value="0.00" disabled>
                    </div>
                    <div class="col-md-2">
                        <label for="assimilated">Asimilado</label>
                        <input class="form-control" type="text" name="assimilated" id="assimilated" value="0.00" disabled>
                    </div>
                    <div class="col-md-2">
                        <label for="total">Total</label>
                        <input class="form-control" type="text" name="total" id="total" value="0.00" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <input class="form-control" type="text" name="contracted_days_two" id="contracted_days_two" value="90" disabled>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <input class="form-control" type="text" name="antiquity" id="antiquity" disabled>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="row row-end">
                <div class="col-md-4">
                    ...
                    <input class="form-control" type="text" name="recruiter" id="recruiter" disabled>
                </div>
