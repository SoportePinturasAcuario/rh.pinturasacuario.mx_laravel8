...
class CollaboratorsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(),[
            ...
            'Nombre_del_empleado'=>'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,.\"]+$/',
            'Edad'=>'required|digits:2',
            'Sexo'=>'required',
            'Lugar_de_nacimiento'=>'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            'Fecha_de_nacimiento'=>'required',
            'Escolaridad'=>'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            'Telefono'=>'required|digits:10',
            'Correo_electronico' => 'required|email',
            'Calle_numero' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜ .#°,0-9"]+$/',
            'Colonia' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            'Municipio' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            ...
            'Puesto' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            'Departamento' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            'Responde_a' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            'Actividad' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜ ,."]+$/',
            'Nomina' => 'required',
            'Empresa' => 'required',
            ...
            'Centro' => 'required',
            'Area_nomina' => 'required|regex:/^[A-ZÁÉÍÓÚÑÜa-z ,."]+$/',
            'Estatus_del_expediente' => 'required',
            'CI_nuevo' => 'required',
            'avc' => 'regex:/^[A-ZÁÉÍÓÚÑÜa-z ,]+$/',
